...
async def service_단일다중회사주요계정(client, req, BASE_URL):
    params = {
        "crtfc_key": OPENDART_API_KEY,
        "corp_code": req.corp_code,
        "bsns_year": req.bsns_year,
...
async def service_단일회사전체재무재표(client, req, BASE_URL):
    params = {
        "crtfc_key": OPENDART_API_KEY,
        "corp_code": req.corp_code,
        "bsns_year": req.bsns_year,
...
async def service_단일다중회사주요재무지표(client, req, BASE_URL):
    params = {
        "crtfc_key": OPENDART_API_KEY,
        "corp_code": req.corp_code,
        "bsns_year": req.bsns_year,
        "reprt_code": req.reprt_code,
        "idx_cl_code": req.idx_cl_code
    }
...
async def service_지분공시(client, req, BASE_URL):
    params = {
        "crtfc_key": OPENDART_API_KEY,
        "corp_code": req.corp_code,
    }
...
async def service_주요사항(client, req, BASE_URL):
    params = {
        "crtfc_key": OPENDART_API_KEY,
        "corp_code": req.corp_code,
        "bgn_de": req.bgn_de,
...
async def service_증권신고서(client, req, BASE_URL):
    params = {
        "crtfc_key": OPENDART_API_KEY,
        "corp_code": req.corp_code,
        "bgn_de": req.bgn_de,
